...
- An 8-trading-day gap in EOD journals (2026-06-22 to 2026-07-02) forced the learning-coach to operate blind, reconstructing context from the task description alone instead of reading the record. The `docs/journal/<date>.md` entry is as mandatory as the morning decision file — without it, lessons cannot be drawn from experience. — 2026-07-02
...
## Changelog
- 2026-07-02 — Added lesson: EOD journal gap is a distinct process failure; docs/journal/<date>.md is as mandatory as the morning decision file.
