...
- Sector rotation creates thesis-research deadlines, not just aspirational to-dos. The 2026-09-12 weekly screen showed MCD -22.6%, NKE -31.8%, WMT -15.3%, PEP -14.8% over six months — four large-cap quality businesses discounting meaningfully while the three covered names (AAPL, MSFT, V) remained 20-60% above their fair-value ranges for the portfolio's entire 87-day history. Opportunity windows in discounting names are finite; a thesis cannot be written after the price has recovered. When a weekly screen identifies four or more quality names down 15%+ in sectors with no thesis coverage, writing those theses is a dated obligation with a closing deadline, not optional weekend research. — 2026-09-12

- Do not lower the margin-of-safety threshold in response to zero fills — diagnose whether the bench is narrow, not whether the bar is too high. After 87 days with zero fills, all three covered names (AAPL, MSFT, V) traded 13-62% above their fair-value ranges throughout the portfolio's history; the threshold was never the binding constraint. Lowering the MOS threshold to force entry on richly-priced names would destroy the discipline the threshold exists to provide. The correct fix is more names closer to fair value, not a lower hurdle for names already far from it. The tuner confirmed this on 2026-09-12: gate open, no change warranted. — 2026-09-12
...
## Changelog
- 2026-09-12 — Added lesson: sector rotation toward MCD/NKE/WMT/PEP (-15% to -32%) while covered bench stays 20-60% above fair value makes thesis-research a dated obligation with a closing window, not optional weekend work.
- 2026-09-12 — Added lesson: do not lower the MOS threshold in response to zero fills; after 87 days all three covered names were 13-62% above fair value — the bench is too narrow, not the bar too high. Tuner confirmed no parameter change warranted.
