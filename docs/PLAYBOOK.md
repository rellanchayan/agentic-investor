...
- After 20 trading days from inception with zero executions and at least one active written thesis, run a retrospective price audit for each candidate: if no candidate ever crossed its buy threshold, the margin-of-safety parameters deserve formal scrutiny; if any did cross the threshold and was missed, the process failure now has a measured cost. Disciplined restraint and threshold miscalibration look identical from the outside without this audit. — 2026-08-07
...
## Changelog
- 2026-08-07 — Added lesson: after 20 trading days with zero executions and active thesis candidates, a retrospective price audit is mandatory to distinguish disciplined restraint from threshold miscalibration.
