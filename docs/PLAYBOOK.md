...
- The Saturday weekly-research routine is a mandatory scheduled obligation with the same standing as the morning decision file and the EOD journal — it must produce a written record every Saturday the market is closed (thesis refreshes, new names screened, calibration reviewed). Two consecutive Saturdays (2026-08-09 and 2026-08-16) produced no weekly-research output in `docs/`; there is no way to know whether any names were screened, whether the thesis bench was extended, or whether calibration findings were reviewed. Without a written record the routine may as well not have run. Treat a missing weekly-research file for any Saturday as a process failure, not a deliberate skip — the same standard applied to the morning decision file on 2026-06-18. — 2026-08-22
...
## Changelog
- 2026-08-22 — Added lesson: the Saturday weekly-research routine is a mandatory scheduled obligation; a missing weekly-research file is a process failure, not a deliberate skip — same standard as the daily morning decision file.
