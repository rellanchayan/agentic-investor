...
- With three thesis-backed names all trading 26-60% above their fair-value ranges after 90 days, and four large-cap consumer names (NKE -32%, MCD -23%, WMT -14%, PEP -15% over six months as of 2026-09-05) repeatedly flagged in decision files as "worth a hard look" but never researched, a clear directional rule emerges: when expanding the thesis bench in a quality-at-fair-price framework, prioritize names with meaningful six-month price declines over names in strong uptrends. A name rising persistently well above its 200-day SMA will almost always fail the margin-of-safety test on the first price check; a name that has declined 15%+ may have crossed from "clearly too expensive" into "requires a valuation." The research queue should lead with declining quality businesses — not because they are buys, but because they are the candidates most likely to be approaching the range where our standards can be met. Directing research effort toward rising names first is a systematic misallocation of the one resource (filing-backed valuation work) that creates optionality. — 2026-09-05
...
## Changelog
- 2026-09-05 — Added lesson: when expanding the thesis bench, prioritize quality names with 15%+ six-month price declines over names in strong uptrends; declining names are structurally more likely to be approaching fair-value entry range, while rising names will almost always fail the MOS test on the first check.
